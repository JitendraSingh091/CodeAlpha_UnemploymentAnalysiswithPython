...
if option == "Average Unemployment rate by region":
    st.image("image/Average Unemployment rate by region.png",
             use_container_width = True)
    

elif option == "Average Unemployment rate overtime":
    st.image("image/Average Unemployment rate overtime.png",
             use_container_width = True)
    

elif option == "Change in Average Unemployment Rate by Region":
    st.image("image/Change in Average Unemployment Rate by Region.png",
             use_container_width = True)


elif option == "Distribution of unemployment Rates in india":
    st.image("image/Distribution of unemployment Rates in india.png",
             use_container_width = True)


elif option == "Labour Participation vs Unemployment Rate":
    st.image("image/Labour Participation vs Unemployment Rate.png",
             use_container_width = True)


elif option == "UnEmployment Rate Before and During Covid":
    st.image("image/UnEmployment Rate Before and During Covid.png",
             use_container_width = True)    
